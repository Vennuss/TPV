 ...
 */
public class PanelUsuarios extends javax.swing.JDialog {
     ...
     */
    public PanelUsuarios(boolean busqueda,java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cargarFiltro() {
        ...
        if (txtBusqueda.getText().length() > 0) {
            switch (this.cmbBusqueda.getSelectedIndex()) {
                case 0:
                    filtro = " where dni like '%" + txtBusqueda.getText() + "%' or nombres like '%" + txtBusqueda.getText() + "%' or apellidos like '%" + txtBusqueda.getText() + "%'";
                    break;
                case 1:
                    filtro = " where dni like '%" + txtBusqueda.getText() + "%'";
                    break;
                case 2:
                    filtro = " where nombres like '%" + txtBusqueda.getText() + "%'";
                    break;
                case 3:
                    filtro = " where apellidos like '%" + txtBusqueda.getText() + "%'";
                    break;
                case 4:
                    filtro = " where correo like '%" + txtBusqueda.getText() + "%'";
                    break;
                case 5:
                    filtro = " where login like '%" + txtBusqueda.getText() + "%'";
                    break;
                default:
    ...
    public final void recuperarDatos() {
        Modelo();
        DefaultTableModel tm = (DefaultTableModel) this.tbClientes.getModel();
        this.tbClientes.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

        String sql = "select dni, nombres, login,apellidos, correo from usuarios" + filtro;
        try {
            ...
            while (rs.next()) {
                ...
                Object nuev[] = {dni, nombres, apellidos, login, correo};
                tm.addRow(nuev);
            }
    ...
    private void initComponents() {
        ...
        setTitle("PANEL DE ADMINISTRACION DE USUARIOS");
        ...
        cmbBusqueda.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Defecto:", "DNI:", "Nombres:", "Apellidos:", "Correo:", "Login:" }));
    ...
    private void btSeleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSeleActionPerformed
        int fila = this.tbClientes.getSelectedRow();
        ...
        if (this.tbClientes.getSelectedRow() != -1) {
            ...
            this.usuario = new Usuario(codigo);
    ...
    private void btAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAñadirActionPerformed
        ...
        frUsuario dialog = new frUsuario(usuario, true, new javax.swing.JFrame(), true);
    ...
    private void btModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btModificarActionPerformed
        ...
        if (this.tbClientes.getSelectedRow() != -1) {
            ...
            usuario.recuperaDatos();           
            frUsuario dialog = new frUsuario(usuario, false, new javax.swing.JFrame(), true);
            dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosing(java.awt.event.WindowEvent e) {
                    //System.exit(0);
            ...
            dialog.setVisible(true);
            if (dialog.getResult() == JOptionPane.YES_NO_OPTION) {
                modelo.setValueAt(usuario.getNombres(), fila, 1);
                modelo.setValueAt(usuario.getApellidos(), fila, 2);
                modelo.setValueAt(usuario.getLogin(), fila, 3);
                modelo.setValueAt(usuario.getCorreo(), fila, 4);
            } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PanelUsuarios dialog = new PanelUsuarios(true, new javax.swing.JFrame(), true);
                dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                    @Override
                    public void windowClosing(java.awt.event.WindowEvent e) {
                        System.exit(0);
