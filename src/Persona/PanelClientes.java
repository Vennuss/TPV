...
public class PanelClientes extends javax.swing.JDialog {
     ...
     */
    public PanelClientes(boolean busqueda, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public final void recuperarDatos() {
        ...
        String sql = "select dni, nombres, apellidos, correo from clientes" + filtro;
        try {
            ...
            while (rs.next()) {
                ...
                Object nuev[] = {dni, nombres, apellidos, correo};
                tm.addRow(nuev);
            }
    ...
    private void btSeleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSeleActionPerformed
        ...
        if (this.tbClientes.getSelectedRow() != -1) {
            ...
            this.cliente = new Cliente(codigo);
    ...
    private void btAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAñadirActionPerformed
        ...
        frCliente dialog = new frCliente(cliente, true, new javax.swing.JFrame(), true);
    ...
    private void btModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btModificarActionPerformed
        ...
        if (this.tbClientes.getSelectedRow() != -1) {
            ...
            cliente.recuperaDatos();
            frCliente dialog = new frCliente(cliente, false, new javax.swing.JFrame(), true);
            dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                @Override
                public void windowClosing(java.awt.event.WindowEvent e) {
                    //System.exit(0);
            ...
            dialog.setVisible(true);
            if (dialog.getResult() == JOptionPane.YES_NO_OPTION) {
                modelo.setValueAt(cliente.getNombres(), fila, 1);
                modelo.setValueAt(cliente.getApellidos(), fila, 2);
                modelo.setValueAt(cliente.getCorreo(), fila, 3);
            } else {
